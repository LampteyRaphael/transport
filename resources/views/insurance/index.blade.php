...
@section('content')
    ...
    {!! Form::open(['method'=>'POST','action'=>'insuranceController@store','class'=>'modal model-default','id'=>'date', 'tabindex'=>'','aria-hidden'=>'true','role'=>'dialog'] ) !!}
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                Insurance Data Entry Point
            </div>
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            @foreach($insurances as $insurance)
                <tr>
                    <td>{{$insurance->vehicle? $insurance->vehicle->make:''}}</td>
                    <td>{{$insurance->renewalDate}}</td>
                    <td>{{$insurance->expiringDate}}</td>
                    <td><a href="{{route('insurance.edit',$insurance->id)}}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a></td>
                    <td>
                        {!! Form::model($insurance,['method'=>'DELETE','action'=>['insuranceController@destroy',$insurance->id],'onsubmit' => 'return ConfirmDelete()',],['class'=>'form-inline'])!!}
