                        ...
                        <div class="panel-body" style="padding-bottom: 200px;padding-top:10px;">
                            ...
                            <p class="text-center">
                                ...
                                @else
                                    ...
                                    {{--                                    <a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Try to Login again or see your church administrator for help</a>--}}
